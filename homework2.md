...
- There is now a .devcontainer folder in the hw2 repository
...
- Next, open your cloned hw2 folder in VSCode. There might be a popup stating "Folder contains a Dev Container configuration file. Reopen in Container?" Click on the option to reopen in container.
